...
- Plugin upload endpoint with validation, datastore plugin system, per-server admin queues, AIO globalSetup test infrastructure, case-insensitive route lookups, tarball blob exclusion from queries, worktree hook fixes, pre-push simplified to offline tests.
